# modules/dart/manifests/mdct_tcir_production.pp
#
# Synopsis:
#       (TCIR) Toolcrib Inventory Review Database (production)
#
# Contact:
#       Ben Minshall

class dart::mdct_tcir_production inherits dart::abstract::tcir_server_node {
