...
#
#   [*modules_dir*]
#      The directory where compiled modules will live on a system.
...
define selinux::module(
    Enum['present', 'enabled', 'disabled', 'absent'] $ensure = 'present',
    String $modules_dir = '/usr/share/selinux',
    Optional[String] $source = undef,
    Optional[String] $ignore = undef,
    ) {

    # .te and .fc files will be placed on a $name directory
    $this_module_dir = "${modules_dir}/${name}"
